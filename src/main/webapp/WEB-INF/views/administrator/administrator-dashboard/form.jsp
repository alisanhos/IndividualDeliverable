...
<h2>
	<acme:message code="administrator.dashboard.form.title.talmonu"/>
</h2>
...
<table class="table table-sm">
	...
	<tr>
		...
		<td>
			<acme:print value="${ratioOfItemWithTalmonu}"/>
		</td>
	</tr>
</table>
...
<table class="table table-sm">
	<jstl:forEach var="entry" items="${statsExpenditureOfTalmonu}">
		<tr>
			<th scope="row">
				<acme:message code="administrator.dashboard.form.label.currency"/>
			</th>
