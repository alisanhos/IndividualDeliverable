package acme.entities.talmonus;
...
@Getter
@Setter
public class Talmonu extends AbstractEntity{
	...
	@Pattern(regexp = "^\\d{2}\\w{4}\\/(0?[1-9]|1[012])\\/(0?[1-9]|[12][0-9]|3[01])$", message = "inventor.talmonu.form.error.code-regex")
	/*   “^yy\w{4}/mm/dd$
	...
	secuencia que se incremente automaticamente con cada talmonu que salga.
	...
	*/
	...
	protected String theme; // Title
	
	@NotBlank
	@Length(min = 1, max=255)
	protected String explanation; // Description
	
	@NotNull
	protected Date startPeriod; //Start of the period
	...
	@Valid
	@NotNull
	protected Money expenditure; // Budget positive
	
	@URL
	protected String furtherInfo; // Optional Link
