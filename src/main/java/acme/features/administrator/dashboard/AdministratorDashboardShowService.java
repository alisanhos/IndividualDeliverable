...
public class AdministratorDashboardShowService implements AbstractShowService<Administrator, AdministratorDashboard>{
	...
	public AdministratorDashboard findOne(final Request<AdministratorDashboard> request) {
		...
		//Tool
		final double ratioOfItemWithTalmonu = this.repository.ratioOfItemWithTalmonu(ItemType.TOOL);
		//Component
		//final double ratioOfItemWithTalmonu = this.repository.ratioOfItemWithTalmonu(ItemType.COMPONENT);
		
		final Map<String, Stats> statsExpenditureOfTalmonu = new HashMap<>();
		final List<Object[]> listStatsExpenditureOfTalmonu = this.repository.statsExpenditureOfTalmonu();
		
		for (int i=0; i<listStatsExpenditureOfTalmonu.size(); i++) {
			final Object[] arrayList = listStatsExpenditureOfTalmonu.get(i);
			final Stats stat = new Stats();
			stat.setAverage((Double)(arrayList[1]));
			stat.setDeviation((Double)(arrayList[2]));
			stat.setMinumun((Double)(arrayList[3]));
			...
			statsExpenditureOfTalmonu.put((String)arrayList[0], stat);
		}
		
		result.setRatioOfItemWithTalmonu(ratioOfItemWithTalmonu);
		result.setStatsExpenditureOfTalmonu(statsExpenditureOfTalmonu);
	...
	public void unbind (final Request<AdministratorDashboard> request, final AdministratorDashboard entity, final Model model) {
		...
		request.unbind(entity, model, 	"numberOfComponents", 
										...
										"ratioOfItemWithTalmonu",
										"statsExpenditureOfTalmonu");
	}
}
